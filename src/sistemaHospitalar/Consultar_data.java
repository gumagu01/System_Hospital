...
public class Consultar_data extends javax.swing.JFrame {

  
    public Consultar_data() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_data().setVisible(true);
            }
        });
    }
